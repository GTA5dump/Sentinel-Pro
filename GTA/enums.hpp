...
enum class eNetworkEvents : std::uint16_t
{
...
inline static const eRagdollBlockingFlags g_RagdollBlockingFlags[] =
{
...
enum eAnimationFlags : std::uint32_t
{
	eAnimationNormal = 0,
	eAnimationRepeat = 1,
	eAnimationStopLastFrame = 2,
	eAnimationUpperBody = 16,
	eAnimationEnablePlayerControl = 32,
	eAnimationCancelable = 120,
	eAnimationCreature = 256
};
